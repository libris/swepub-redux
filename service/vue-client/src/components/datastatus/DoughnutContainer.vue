...
const DoughnutChart = () => import('@/components/datastatus/DoughnutChart');
const ChartLegend = () => import('@/components/datastatus/ChartLegend');
const SrChartTable = () => import('@/components/datastatus/SrChartTable');
