...
const TabMenu = () => import('@/components/shared/TabMenu');
const HarvestLatest = () => import('@/components/process/HarvestLatest');
const HarvestHistory = () => import('@/components/process/HarvestHistory');
