...
const PreviewTable = defineAsyncComponent(() => import('@/components/shared/PreviewTable.vue'));
...
export default {
  ...
  computed: {
    ...
    apiPath() {
      return `${this.apiPath}/process/${this.harvestId}/rejected?limit=${this.previewLimit}`;
    },
    previewInfo() {
