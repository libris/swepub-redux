...
def test_orcid_invalid_format_validation():
    orcid = ['00010002X8250092',  # Containing incorrect char
             '00010002250092',  # Too few och digits
             '000000000218250092']  # Too many digits

    expected_results = [(False, 'format'),
                        (False, 'format'),
                        (False, 'format')]
