...
def test_orcid_valid_format_validation():
    orcid = [
        ...
        "0000-0002-9079-593x",  # Valid ORCID
        "0009-2240-5865-1237",  # Valid ORCID
...
def test_orcid_invalid_format_validation():
    orcid = [
        ...
        "000000000218250092", # Too many digits
    ]
...
def test_orcid_invalid_span_validation():
    orcid = [
        ...
        "0009-0010-0000-0010",  # Value too large
        "0000-0001-4999-9999",  # Value too small
        "0008-0000-0000-0000",  # Value too small
        "0000-0000-0000-0000",  # Value too small
    ]

    expected_results = [(False, "span"), (False, "span"), (False, "span"), (False, "span"), (False, "span"), (False, "span"),]
...
def test_url_stril():
    orcid = [
        ...
        "https://orcid.org/0000-0002-9079-5931", # With https
        "http://orcid.org/0009-2240-5865-1237",  # With http
        "https://orcid.org/0009-2240-5865-1237", # With https
    ]  

    expected_results = ["0000-0002-1825-0097", "0009-2240-5865-1237", "0000-0002-9079-593X", "0000-0002-9079-5931", "0009-2240-5865-1237", "0009-2240-5865-1237"]
