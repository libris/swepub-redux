...
def test_isbn_invalid_format():
    isbn = [
        "ISBN 978-911-307-337-8",  # Incorrect prefix on correct ISBN
...
def test_isbn_invalid_checksum():
    isbn = ["978-911-307-337-2", "000000000X"]  # Incorrect checksum  # Incorrect checksum

    expected_result = [(False, "checksum"), (False, "checksum")]
