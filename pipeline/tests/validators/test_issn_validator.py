...
def test_issn_valid_format():
    issn = [
        "0123-4567",  # Valid format
        "0123-456X",  # Valid format
        "12345678",  # Valid format
        "1234567x",  # Valid format
    ]

    expected_result = [(True, "format"), (True, "format"), (True, "format"), (True, "format")]
...
def test_issn_invalid_format():
    issn = [
        "0123-4567, 0123-456X",  # Two issn = invalid format
...
def test_issn_invalid_checksum():
    issn = [
        "0123-4567",  # Invalid checksum
        "00000001",  # Invalid checksum
        "12345671",  # Invalid checksum
    ]

    expected_result = [(False, "checksum"), (False, "checksum"), (False, "checksum")]
