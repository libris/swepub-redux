...
class OAAuditor(BaseAuditor):
    ...
    def _check_doab(self, publication, audit_events, harvest_cache):
        ...
        identifiers = publication.identifiedby_isbns + publication.identifiedby_dois + publication.identifiedby_partof_dois
        download_uris = []
        ...
        if result:
            new_audit_events = self._add_audit_event(audit_events, code, result, added_electroniclocators)
